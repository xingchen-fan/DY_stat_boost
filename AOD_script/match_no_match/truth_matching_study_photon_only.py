...
print("It begins")
file0 = ROOT.TFile.Open("/eos/user/f/fanx/event_mixing/sample/DY_photon_output_kingscanyon_v1_2018.root", "READ")
...
aodDir = '/afs/cern.ch/user/f/fanx/EOS_space/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/HtoZg_DY_fakePhoton_2018_photonObjectSel/240709_145118/0000/eventmatch_DY_18photon_'+args.number+'.root'
...
outfile = ROOT.TFile('/eos/user/f/fanx/event_mixing/condor_sample/no_match_ph_18' + args.number + '.root', 'RECREATE')
