...
pwd
echo Start cp----------------
cp ../../BuildFile.xml GeneratorInterface/GenFilters
cp ../../SealModule.cc GeneratorInterface/GenFilters/src
cp ../../MatchDYFilter.cc GeneratorInterface/GenFilters/src
cp ../../MatchDYFilter.h GeneratorInterface/GenFilters/interface
