...
cp ../../genFilterFiles/BuildFile.xml GeneratorInterface/GenFilters
cp ../../genFilterFiles/SealModule.cc GeneratorInterface/GenFilters/src
cp ../../genFilterFiles/MatchDYFilter.cc GeneratorInterface/GenFilters/src
cp ../../genFilterFiles/MatchDYFilter.h GeneratorInterface/GenFilters/interface
...
echo "Run cmssw with configuration file"
time cmsRun "$TAG"__DIGIPREMIX__cfg.py
...
rm -rf CMSSW_10_6_19_patch3/src/Configuration
