...
class EventIDFilterDY2018 : public edm::stream::EDFilter<> {
public:
  explicit EventIDFilterDY2018(const edm::ParameterSet&);
  ~EventIDFilterDY2018();
...
//
EventIDFilterDY2018::EventIDFilterDY2018(const edm::ParameterSet& iConfig) {
...
EventIDFilterDY2018::~EventIDFilterDY2018() {
...
bool EventIDFilterDY2018::filter(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void EventIDFilterDY2018::beginStream(edm::StreamID) {
  auto picofile = TFile::Open("root://eosuser.cern.ch//eos/user/f/fanx/DY_output_kingscanyon_v1_2018_merge.root", "READ");
  Long64_t event_pico = 0;
  auto tree = (TTree*)picofile->Get("tree");
  tree->SetBranchAddress("event", &event_pico);
...
void EventIDFilterDY2018::endStream() {
  id_list.clear();
}
...
void EventIDFilterDY2018::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(EventIDFilterDY2018);
